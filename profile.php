...
$sql="UPDATE tblusers set fullname=:name,phonenumber=:mobileno where emailid=:email";
...
<meta name="keywords" content="DDS | Discover Destination System In PHP" />
...
<p style="width: 350px;">
<b>Mobile Number</b>
<input type="text" class="form-control" name="mobileno" maxlength="10" value="<?php echo htmlentities($result->phonenumber);?>" id="mobileno"  required="">
</p>
